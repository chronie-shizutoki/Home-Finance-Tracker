...
/**
 * Applies a vibrancy (frosted glass) color boost to a [BackdropEffectScope].
 *
 * This effect adjusts the backdrop's color controls to simulate the "vibrancy"
 ...
 * blurred background content appear more vivid and colorful through the glass.
 *
